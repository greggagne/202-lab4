...
public class TestArraySet {
	...
	public void testUnion() {
		Set<Integer> s1 = new ArraySet<>();
		Set<Integer> s2 = new ArraySet<>();
		Set<Integer> s3;
		Set<Integer> s4 = new ArraySet<>();
		Set<Integer> s5;
		Set<Integer> s6;
		Set<Integer> s7 = new ArraySet<>();
		Set<Integer> s8;
